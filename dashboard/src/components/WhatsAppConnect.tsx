         ...
         <div className="flex-1 space-y-6">
            ...
            <ol className="space-y-5 text-gray-600 dark:text-slate-300 font-medium">
               <li className="flex gap-4 items-start">
                  <span className="bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 w-8 h-8 rounded-full flex items-center justify-center font-bold shrink-0">1</span>
                  <span className="mt-1">Open WhatsApp on your phone.</span>
               </li>
               <li className="flex gap-4 items-start">
                  <span className="bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 w-8 h-8 rounded-full flex items-center justify-center font-bold shrink-0">2</span>
                  <span className="mt-1">Tap <strong>Menu</strong> or <strong>Settings</strong> and select <strong>Linked Devices</strong>.</span>
               </li>
               <li className="flex gap-4 items-start">
                  <span className="bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 w-8 h-8 rounded-full flex items-center justify-center font-bold shrink-0">3</span>
                  <span className="mt-1">Tap on <strong>Link a device</strong>.</span>
               </li>
               <li className="flex gap-4 items-start">
                  <span className="bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 w-8 h-8 rounded-full flex items-center justify-center font-bold shrink-0">4</span>
                  <span className="mt-1">Point your phone to this screen to capture the code.</span>
               </li>
            </ol>
         </div>
            ...
            {status === 'ready' && (
              <div className="flex flex-col items-center text-green-500 animate-in fade-in zoom-in duration-300">
                 ...
                 <div className="flex flex-col items-center gap-2 mt-6">
                    <a href="/groups" className="text-sm text-blue-600 dark:text-blue-400 font-bold hover:underline hover:text-blue-700 dark:hover:text-blue-300 transition-colors">View Groups →</a>
                    <button 
