                ...
                <div className="md:col-span-3 pl-4 space-y-4 text-left overflow-y-auto">
                  ...
                  <div>
                    ...
                    <div className="bg-slate-950 border border-white/5 p-2 rounded-xl text-[10px] space-y-1">
                      <p className="text-slate-400 truncate">≡ƒôì Venue: Grand Hyatt Mumbai</p>
                      <p className="text-emerald-400 truncate font-semibold">≡ƒöù drive.google.com/wedding-ref</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-12">
            <div className="space-y-6 lg:max-w-xl">
              ...
              <ul className="space-y-3 font-sans">
                ...
                <li className="flex items-center gap-3 text-xs text-slate-300">
                  <Check className="w-4 h-4 text-emerald-400 animate-pulse" />
                  <span>No messaging or character count limits ΓÇö host for free locally</span>
                </li>
              </ul>
            </div>
            ...
            <div className="w-full lg:w-96 bg-slate-900 border border-white/10 p-6 rounded-2xl space-y-4">
              ...
              <div className="bg-slate-950 p-4 rounded-xl font-mono text-[10px] text-emerald-400 space-y-1">
                ...
                <p>Γùç Injected environment from .env</p>
                <p>Γùç WhatsApp Web engine initialized</p>
                <p className="text-white">Γ£à WhatsApp Client is Ready! (Connected)</p>
                <p>Γùç Syncing 515 active chats...</p>
              </div>
